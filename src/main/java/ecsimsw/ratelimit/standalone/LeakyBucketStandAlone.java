...
public class LeakyBucketStandAlone<T> implements LeakyBucket<T> {

    private static final Logger LOGGER = LoggerFactory.getLogger(LeakyBucketStandAlone.class);

    private final int flowRate;
    private final int capacity;
    private final BlockingQueue<T> waitings;

    public LeakyBucketStandAlone(int flowRate, int capacity) {
